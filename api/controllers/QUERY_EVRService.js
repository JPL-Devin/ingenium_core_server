...
exports.create_query_evr_step = async function(args, res, next, headers) {
  /**
   * Create a query evr step
   *
   ...
   * returns AddQueryEVRStepResponse
   **/
  ...
  try {
    const data = await node_funcs.createArchiveElement(execution_id, null, "STEP", "QUERY_EVR", step, insert_after_id, level, key); 
...
exports.get_execution_query_evr_steps = async function(args, res, next, headers) {
  /**
   * Get query EVR steps of the execution. List is sorted by the order in the execution.
   *
   * execution_id String unique id of execution
...
exports.get_query_evr_step = async function(args, res, next, headers) {
  /**
   * Get a query evr step
   *
   * elem_id String unique id of a procedure element
   * returns QueryEVRStep
   **/
  const key = node_funcs.get_auth_key(headers);
  let execution_id = args['execution_id']['value'];
...
exports.get_query_evr_step_input = async function(args, res, next, headers) {
  /**
   * Get user input of a query evr step
   *
   * elem_id String unique id of a procedure element
   * returns QueryEVRValueSpec
   **/
  const key = node_funcs.get_auth_key(headers);
  let execution_id = args['execution_id']['value'];
  let elem_id = args['elem_id']['value'];
...
exports.get_query_evr_step_result = async function(args, res, next, headers) {
  /**
   * Get result of a query evr step
   *
   * elem_id String unique id of a procedure element
   * returns QueryEVRResultSpec
   **/
  const key = node_funcs.get_auth_key(headers);
  let execution_id = args['execution_id']['value'];
  let elem_id = args['elem_id']['value'];
...
exports.update_query_evr_step = async function(args, res, next, headers) {
  /**
   * Update a query evr step
   *
   * elem_id String unique id of a procedure element
   * step QueryEVRStep Definition of query evr step
...
exports.update_query_evr_step_input = async function(args, res, next, headers) {
  /**
   * Update user input of a query evr step
   *
   * elem_id String unique id of a procedure element
   * user_input QueryEVRValueSpec User input values
   * no response value expected for this operation
   **/
  const key = node_funcs.get_auth_key(headers);
  let execution_id = args['execution_id']['value'];
