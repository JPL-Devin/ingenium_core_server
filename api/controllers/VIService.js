...
exports.create_vi_step = async function(args, res, next, headers) {
  /**
  ...
  try {
    const data = await node_funcs.createArchiveElement(execution_id, null, "STEP", "VERIFICATION_ITEM", step, insert_after_id, level, key); 
...
exports.get_execution_vi_ids = async function(args, res, next, headers) {
  /**
  ...
  try {
    const data = await node_funcs.getVIs(execution_id, filter, key); 
    res.status(200).json(data);
  } catch (err) {
...
exports.get_execution_vi_steps = async function(args, res, next, headers) {
  /**
...
exports.get_vi_step = async function(args, res, next, headers) {
  /**
   * Get a VI step
   *
...
exports.update_vi_step = async function(args, res, next, headers) {
  /**
   * Update a VI step
   *
   * step_id String unique id of step
...
exports.get_vi_step_input = async function(args, res, next, headers) {
  /**
   * Get a VI step input
   *
   * step_id String unique id of step
...
exports.update_vi_step_input = async function(args, res, next, headers) {
  /**
   * Update a VI step input
   *
   * step_id String unique id of step
   * user_input VIStepInput Definition of VI step
   * no response value expected for this operation
   **/
  const key = node_funcs.get_auth_key(headers);
  let execution_id = args['execution_id']['value'];
