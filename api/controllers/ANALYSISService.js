...
exports.create_analysis_step = async function(args, res, next, headers) {
  /**
  ...
  try {
    const data = await node_funcs.createArchiveElement(execution_id, null, "STEP", "ANALYSIS", step, insert_after_id, level, key); 
...
exports.get_analysis_step = async function(args, res, next, headers) {
  /**
   * Get a analysis step
   *
...
exports.get_analysis_step_input = async function(args, res, next, headers) {
  const key = node_funcs.get_auth_key(headers);
  let execution_id = args['execution_id']['value'];
  let elem_id = args['elem_id']['value'];
...
exports.get_analysis_step_result = async function(args, res, next, headers) {
  /**
   * Get result of a analysis step
   *
   * elem_id String unique id of a procedure element
   * returns AnalysisStepResult
   **/
  const key = node_funcs.get_auth_key(headers);
  let execution_id = args['execution_id']['value'];
  let elem_id = args['elem_id']['value'];
...
exports.get_execution_analysis_steps = async function(args, res, next, headers) {
  /**
...
exports.update_analysis_step = async function(args, res, next, headers) {
  /**
