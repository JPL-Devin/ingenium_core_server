...
exports.create_procedure_venue_config_step = async function(args, res, next, headers) {
  /**
   ...
   * returns AddVenueConfigStepResponse
   **/
  ...
  try {
    const data = await node_funcs.createArchiveElement(null, procedure_id, "STEP", "VENUE_CONFIG_MANUAL", step, insert_after_id, level, key); 
...
exports.get_procedure_venue_config_step = async function(args, res, next, headers) {
  /**
...
exports.get_procedure_venue_config_step_input = async function(args, res, next, headers) {
  /**
...
exports.get_procedure_venue_config_steps = async function(args, res, next, headers) {
  /**
...
exports.update_procedure_venue_config_step = async function(args, res, next, headers) {
  /**
...
exports.update_procedure_venue_config_step_input = async function(args, res, next, headers) {
  /**
