...
exports.create_procedure_environment_step = async function(args, res, next, headers) {
  /**
   ...
   * returns AddEnvironmentStepResponse
   **/
  ...
  try {
    const data = await node_funcs.createArchiveElement(null, procedure_id, "STEP", "ENVIRONMENT_MANUAL", step, insert_after_id, level, key); 
...
exports.get_procedure_environment_step = async function(args, res, next, headers) {
  /**
...
exports.get_procedure_environment_step_input = async function(args, res, next, headers) {
  /**
...
exports.get_procedure_environment_steps = async function(args, res, next, headers) {
  /**
...
exports.update_procedure_environment_step = async function(args, res, next, headers) {
  /**
...
exports.update_procedure_environment_step_input = async function(args, res, next, headers) {
  /**
