...
exports.create_procedure_gds_step = async function(args, res, next, headers) {
  /**
   * Create a GDS step
   *
  ...
  try {
    const data = await node_funcs.createArchiveElement(null, procedure_id, "STEP", "GDS_MANUAL", step, insert_after_id, level, key); 
...
exports.get_procedure_gds_step = async function(args, res, next, headers) {
  /**
   * Get a GDS step
   *
   * procedure_id String unique id of procedure
...
exports.get_procedure_gds_step_input = async function(args, res, next, headers) {
  /**
...
exports.get_procedure_gds_steps = async function(args, res, next, headers) {
  /**
...
exports.update_procedure_gds_step = async function(args, res, next, headers) {
  /**
   * Update a GDS step
   *
   * procedure_id String unique id of procedure
...
exports.update_procedure_gds_step_input = async function(args, res, next, headers) {
  /**
