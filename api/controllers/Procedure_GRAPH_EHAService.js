...
exports.create_procedure_graph_eha_step = async function(args, res, next, headers) {
  /**
  ...
  try {
    const data = await node_funcs.createArchiveElement(null, procedure_id, "STEP", "GRAPH_EHA", step, insert_after_id, level, key); 
...
exports.get_procedure_graph_eha_step = async function(args, res, next, headers) {
  /**
...
exports.get_procedure_graph_eha_step_input = async function(args, res, next, headers) {
  /**
...
exports.get_procedure_graph_eha_steps = async function(args, res, next, headers) {
  /**
...
exports.update_procedure_graph_eha_step = async function(args, res, next, headers) {
  /**
...
exports.update_procedure_graph_eha_step_input = async function(args, res, next, headers) {
  /**
