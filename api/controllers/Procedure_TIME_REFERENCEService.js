...
exports.create_procedure_time_reference_step = async function(args, res, next, headers) {
  /**
  ...
  try {
    const data = await node_funcs.createArchiveElement(null, procedure_id, "STEP", "TIME_REFERENCE", step, insert_after_id, level, key); 
...
exports.get_procedure_time_reference_step = async function(args, res, next, headers) {
  /**
...
exports.get_procedure_time_reference_step_input = async function(args, res, next, headers) {
  /**
...
exports.get_procedure_time_reference_steps = async function(args, res, next, headers) {
  /**
...
exports.update_procedure_time_reference_step = async function(args, res, next, headers) {
  /**
...
exports.update_procedure_time_reference_step_input = async function(args, res, next, headers) {
  /**
