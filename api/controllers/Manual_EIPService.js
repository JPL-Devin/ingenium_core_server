...
exports.create_manual_eip_step = async function(args, res, next, headers) {
  /**
   * Create a manual eip step
   *
  ...
  try {
    const data = await node_funcs.createArchiveElement(execution_id, null, "STEP", "MANUAL_EIP", step, insert_after_id, level, key); 
...
exports.get_execution_manual_eip_steps = async function(args, res, next, headers) {
  /**
   * Get manual eip steps of the execution. List is sorted by the order in the execution.
   *
   * execution_id String unique id of execution
...
exports.get_manual_eip_step = async function(args, res, next, headers) {
  /**
   * Get a manual eip step
   *
...
exports.get_manual_eip_step_input = async function(args, res, next, headers) {
  /**
   * Get user input of a manual eip step
   *
   * step_id String unique id of step
...
exports.get_manual_eip_step_result = async function(args, res, next, headers) {
  /**
   * Get result of a manual eip step
   *
   * step_id String unique id of step
...
exports.update_manual_eip_step = async function(args, res, next, headers) {
  /**
   * Update a manual eip step
   *
   * step_id String unique id of step
   * step ManualInputStep Definition of manual eip step
...
exports.update_manual_eip_step_input = async function(args, res, next, headers) {
  /**
   * Update user input of a manual eip step
   *
   * step_id String unique id of step
