...
exports.create_procedure_manual_input_step = async function(args, res, next, headers) {
  /**
   ...
   * returns AddManualInputStepResponse
   **/
  ...
  try {
    const data = await node_funcs.createArchiveElement(null, procedure_id, "STEP", "MANUAL_INPUT", step, insert_after_id, level, key); 
...
exports.get_procedure_manual_input_step = async function(args, res, next, headers) {
  /**
...
exports.get_procedure_manual_input_step_input = async function(args, res, next, headers) {
  /**
...
exports.get_procedure_manual_input_steps = async function(args, res, next, headers) {
  /**
...
exports.update_procedure_manual_input_step = async function(args, res, next, headers) {
  /**
...
exports.update_procedure_manual_input_step_input = async function(args, res, next, headers) {
  /**
