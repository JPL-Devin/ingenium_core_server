...
exports.create_custom_script_step = async function(args, res, next, headers) {
  /**
   * Create a custom script step
   *
  ...
  try {
    const data = await node_funcs.createArchiveElement(execution_id, null, "STEP", "CUSTOM_SCRIPT", step, insert_after_id, level, key); 
...
exports.get_execution_custom_script_steps = async function(args, res, next, headers) {
  /**
   * Get custom script steps of the execution. List is sorted by the order in the execution.
   *
   * execution_id String unique id of execution
...
exports.get_custom_script_step = async function(args, res, next, headers) {
  /**
   * Get a custom script step
   *
...
exports.get_custom_script_step_input = async function(args, res, next, headers) {
  /**
   * Get user input of a custom script step
   *
   * step_id String unique id of step
   * returns CustomScriptStepInput
   **/
  const key = node_funcs.get_auth_key(headers);
  let execution_id = args['execution_id']['value'];
  let elem_id = args['elem_id']['value'];
...
exports.get_custom_script_step_result = async function(args, res, next, headers) {
  /**
   * Get result of a custom script step
   *
   * step_id String unique id of step
   * returns CustomScriptStepResult
   **/
  const key = node_funcs.get_auth_key(headers);
  let execution_id = args['execution_id']['value'];
  let elem_id = args['elem_id']['value'];
...
exports.update_custom_script_step = async function(args, res, next, headers) {
  /**
   * Update a custom script step
   *
   * step_id String unique id of step
   * step CustomScriptStep Definition of custom script step
...
exports.update_custom_script_step_input = async function(args, res, next, headers) {
  /**
   * Update user input of a custom script step
   *
   * step_id String unique id of step
   * user_input CustomScriptStepInput User input values
   * no response value expected for this operation
   **/
  const key = node_funcs.get_auth_key(headers);
  let execution_id = args['execution_id']['value'];
