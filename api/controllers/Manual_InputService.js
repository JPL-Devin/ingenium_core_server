...
exports.create_manual_input_step = async function(args, res, next, headers) {
  /**
   * Create a manual input step
   *
  ...
  try {
    const data = await node_funcs.createArchiveElement(execution_id, null, "STEP", "MANUAL_INPUT", step, insert_after_id, level, key); 
...
exports.get_execution_manual_input_steps = async function(args, res, next, headers) {
  /**
   * Get manual input steps of the execution. List is sorted by the order in the execution.
   *
   * execution_id String unique id of execution
...
exports.get_manual_input_step = async function(args, res, next, headers) {
  /**
   * Get a manual input step
   *
...
exports.get_manual_input_step_input = async function(args, res, next, headers) {
  /**
   * Get user input of a manual input step
   *
   * step_id String unique id of step
   * returns ManualInputValueSpec
   **/
  const key = node_funcs.get_auth_key(headers);
  let execution_id = args['execution_id']['value'];
  let elem_id = args['elem_id']['value'];
...
exports.get_manual_input_step_result = async function(args, res, next, headers) {
  /**
   * Get result of a manual input step
   *
   * step_id String unique id of step
   * returns ManualInputResultSpec
   **/
  const key = node_funcs.get_auth_key(headers);
  let execution_id = args['execution_id']['value'];
  let elem_id = args['elem_id']['value'];
...
exports.update_manual_input_step = async function(args, res, next, headers) {
  /**
   * Update a manual input step
   *
   * step_id String unique id of step
   * step ManualInputStep Definition of manual input step
...
exports.update_manual_input_step_input = async function(args, res, next, headers) {
  /**
   * Update user input of a manual input step
   *
   * step_id String unique id of step
   * user_input ManualInputValueSpec User input values
   * no response value expected for this operation
   **/
  const key = node_funcs.get_auth_key(headers);
  let execution_id = args['execution_id']['value'];
