...
exports.create_wait_step = async function(args, res, next, headers) {
  /**
   * Create a wait step
   *
  ...
  try {
    const data = await node_funcs.createArchiveElement(execution_id, null, "STEP", "WAIT", step, insert_after_id, level, key); 
...
exports.get_execution_wait_steps = async function(args, res, next, headers) {
  /**
   * Get wait steps of the execution. List is sorted by the order in the execution.
   *
   * execution_id String unique id of execution
...
exports.get_wait_step = async function(args, res, next, headers) {
  /**
   * Get a wait step
   *
...
exports.get_wait_step_input = async function(args, res, next, headers) {
  /**
   * Get user input of a wait step
   *
   * elem_id String unique id of a procedure element
   * returns WaitStepInput
   **/
  const key = node_funcs.get_auth_key(headers);
  let execution_id = args['execution_id']['value'];
  let elem_id = args['elem_id']['value'];
...
exports.get_wait_step_result = async function(args, res, next, headers) {
  /**
   * Get result of a wait step
   *
   * elem_id String unique id of a procedure element
   * returns WaitStepResult
   **/
  const key = node_funcs.get_auth_key(headers);
  let execution_id = args['execution_id']['value'];
  let elem_id = args['elem_id']['value'];
...
exports.update_wait_step = async function(args, res, next, headers) {
  /**
   * Update a wait step
   *
   * elem_id String unique id of a procedure element
   * step WaitStep Definition of wait step
...
exports.update_wait_step_input = async function(args, res, next, headers) {
  /**
   * Update user input of a wait step
   *
   * elem_id String unique id of a procedure element
   * user_input WaitStepInput User input values
   * no response value expected for this operation
   **/
  const key = node_funcs.get_auth_key(headers);
  let execution_id = args['execution_id']['value'];
