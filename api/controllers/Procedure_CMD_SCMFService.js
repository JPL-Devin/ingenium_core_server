...
exports.create_procedure_cmd_scmf_step = async function(args, res, next, headers) {
  /**
  ...
  try {
    const data = await node_funcs.createArchiveElement(null, procedure_id, "STEP", "CMD_SCMF", step, insert_after_id, level, key); 
...
exports.get_procedure_cmd_scmf_step = async function(args, res, next, headers) {
  /**
   * Get a cmd scmf step
   *
   * procedure_id String unique id of procedure
...
exports.get_procedure_cmd_scmf_step_input = async function(args, res, next, headers) {
  /**
   * Get user input of a cmd scmf step
   *
   * procedure_id String unique id of procedure
   * elem_id String unique id of a procedure element
   * returns CmdSCMFStepInput
   **/
  const key = node_funcs.get_auth_key(headers);
  let procedure_id = args['procedure_id']['value'];
  let elem_id = args['elem_id']['value'];
...
exports.get_procedure_cmd_scmf_steps = async function(args, res, next, headers) {
  /**
...
exports.update_procedure_cmd_scmf_step = async function(args, res, next, headers) {
  /**
...
exports.update_procedure_cmd_scmf_step_input = async function(args, res, next, headers) {
  /**
   * Update user input of a cmd scmf step
   *
   * procedure_id String unique id of procedure
   * elem_id String unique id of a procedure element
   * user_input CmdSCMFStepInput User input values
   * no response value expected for this operation
   **/
  const key = node_funcs.get_auth_key(headers);
  let procedure_id = args['procedure_id']['value'];
