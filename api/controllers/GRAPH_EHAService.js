...
exports.create_graph_eha_step = async function(args, res, next, headers) {
  /**
   * Create a graph eha step
   *
   ...
   * returns AddGraphEHAStepResponse
   **/
  ...
  try {
    const data = await node_funcs.createArchiveElement(execution_id, null, "STEP", "GRAPH_EHA", step, insert_after_id, level, key); 
...
exports.get_execution_graph_eha_steps = async function(args, res, next, headers) {
  /**
   * Get graph EHA steps of the execution. List is sorted by the order in the execution.
   *
   * execution_id String unique id of execution
...
exports.get_graph_eha_step = async function(args, res, next, headers) {
  /**
   * Get a graph eha step
   *
   * elem_id String unique id of a procedure element
   * returns GraphEHAStep
   **/
  const key = node_funcs.get_auth_key(headers);
  let execution_id = args['execution_id']['value'];
...
exports.get_graph_eha_step_input = async function(args, res, next, headers) {
  /**
   * Get user input of a graph eha step
   *
   * elem_id String unique id of a procedure element
   * returns GraphEHAValueSpec
   **/
  const key = node_funcs.get_auth_key(headers);
  let execution_id = args['execution_id']['value'];
  let elem_id = args['elem_id']['value'];
...
exports.get_graph_eha_step_result = async function(args, res, next, headers) {
  /**
   * Get result of a graph eha step
   *
   * elem_id String unique id of a procedure element
   * returns GraphEHAResultSpec
   **/
  const key = node_funcs.get_auth_key(headers);
  let execution_id = args['execution_id']['value'];
  let elem_id = args['elem_id']['value'];
...
exports.update_graph_eha_step = async function(args, res, next, headers) {
  /**
   * Update a graph eha step
   *
   * elem_id String unique id of a procedure element
   * step GraphEHAStep Definition of graph eha step
...
exports.update_graph_eha_step_input = async function(args, res, next, headers) {
  /**
   * Update user input of a graph eha step
   *
   * elem_id String unique id of a procedure element
   * user_input GraphEHAValueSpec User input values
   * no response value expected for this operation
   **/
  const key = node_funcs.get_auth_key(headers);
  let execution_id = args['execution_id']['value'];
