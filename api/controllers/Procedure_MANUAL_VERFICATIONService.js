...
exports.create_procedure_manual_verification_step = async function(args, res, next, headers) {
  /**
  ...
  try {
    const data = await node_funcs.createArchiveElement(null, procedure_id, "STEP", "MANUAL_VERIFICATION", step, insert_after_id, level, key); 
...
exports.get_procedure_manual_verification_step = async function(args, res, next, headers) {
  /**
...
exports.get_procedure_manual_verification_step_input = async function(args, res, next, headers) {
  /**
   * Get user input of a manual verification step
   *
   * procedure_id String unique id of procedure
   * elem_id String unique id of a procedure element
   * returns ManualVerificationStepAuthoringInput
   **/
  const key = node_funcs.get_auth_key(headers);
  let procedure_id = args['procedure_id']['value'];
  let elem_id = args['elem_id']['value'];
...
exports.get_procedure_manual_verification_steps = async function(args, res, next, headers) {
  /**
...
exports.update_procedure_manual_verification_step = async function(args, res, next, headers) {
  /**
...
exports.update_procedure_manual_verification_step_input = async function(args, res, next, headers) {
  /**
   * Update user input of a manual verification step
   *
   * procedure_id String unique id of procedure
   * elem_id String unique id of a procedure element
   * user_input ManualVerificationStepAuthoringInput User input values
   * no response value expected for this operation
   **/
  const key = node_funcs.get_auth_key(headers);
  let procedure_id = args['procedure_id']['value'];
