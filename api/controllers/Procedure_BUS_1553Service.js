...
exports.create_procedure_bus_1553_step = async function(args, res, next, headers) {
  /**
  ...
  try {
    const data = await node_funcs.createArchiveElement(null, procedure_id, "STEP", "BUS_1553", step, insert_after_id, level, key); 
...
exports.get_procedure_bus_1553_step = async function(args, res, next, headers) {
  /**
   * Get a bus 1553 step
   *
   * procedure_id String unique id of procedure
...
exports.get_procedure_bus_1553_step_input = async function(args, res, next, headers) {
  /**
   * Get user input of a bus 1553 step
   *
   * procedure_id String unique id of procedure
   * elem_id String unique id of a procedure element
   * returns Bus1553StepInput
   **/
  const key = node_funcs.get_auth_key(headers);
  let procedure_id = args['procedure_id']['value'];
  let elem_id = args['elem_id']['value'];
...
exports.get_procedure_bus_1553_steps = async function(args, res, next, headers) {
  /**
   * Get bus 1553 steps of the procedure. List is sorted by the order in the procedure.
   *
   * procedure_id String unique id of procedure
...
exports.update_procedure_bus_1553_step = async function(args, res, next, headers) {
  /**
...
exports.update_procedure_bus_1553_step_input = async function(args, res, next, headers) {
  /**
   * Update user input of a bus 1553 step
   *
   * procedure_id String unique id of procedure
   * elem_id String unique id of a procedure element
   * user_input Bus1553StepInput User input values
   * no response value expected for this operation
   **/
  const key = node_funcs.get_auth_key(headers);
  let procedure_id = args['procedure_id']['value'];
