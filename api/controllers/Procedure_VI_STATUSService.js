...
exports.create_procedure_vi_status_step = async function(args, res, next, headers) {
  /**
  ...
  try {
    const data = await node_funcs.createArchiveElement(null, procedure_id, "STEP", "VERIFICATION_ITEM_STATUS", step, insert_after_id, level, key); 
...
exports.get_procedure_vi_status_step = async function(args, res, next, headers) {
  /**
...
exports.get_procedure_vi_status_steps = async function(args, res, next, headers) {
  /**
...
exports.update_procedure_vi_status_step = async function(args, res, next, headers) {
  /**
...
exports.get_procedure_vi_status_step_input = async function(args, res, next, headers) {
  /**
...
exports.update_procedure_vi_status_step_input = async function(args, res, next, headers) {
  /**
