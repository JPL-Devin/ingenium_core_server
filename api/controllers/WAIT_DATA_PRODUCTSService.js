...
exports.create_wait_data_products_step = async function(args, res, next, headers) {
  /**
   * Create a wait data products step
   *
   ...
   * returns AddWaitDataProductsStepResponse
   **/
  ...
  try {
    const data = await node_funcs.createArchiveElement(execution_id, null, "STEP", "WAIT_DATA_PRODUCTS", step, insert_after_id, level, key); 
...
exports.get_execution_wait_data_products_steps = async function(args, res, next, headers) {
  /**
   * Get wait data products steps of the execution. List is sorted by the order in the execution.
   *
   * execution_id String unique id of execution
  ...
  let elem_type = 'STEP';
  let step_type = 'WAIT_DATA_PRODUCTS'
...
exports.get_wait_data_products_step = async function(args, res, next, headers) {
  /**
   * Get a wait data products step
   *
   * elem_id String unique id of a procedure element
   * returns WaitDataProductsStep
   **/
  const key = node_funcs.get_auth_key(headers);
  let execution_id = args['execution_id']['value'];
...
exports.get_wait_data_products_step_input = async function(args, res, next, headers) {
  /**
   * Get user input of a wait data products step
   *
   * elem_id String unique id of a procedure element
   * returns WaitDataProductsInputSpec
   **/
  const key = node_funcs.get_auth_key(headers);
  let execution_id = args['execution_id']['value'];
  let elem_id = args['elem_id']['value'];
...
exports.get_wait_data_products_step_result = async function(args, res, next, headers) {
  /**
   * Get result of a wait data products step
   *
   * elem_id String unique id of a procedure element
   * returns WaitDataProductsResultSpec
   **/
  const key = node_funcs.get_auth_key(headers);
  let execution_id = args['execution_id']['value'];
  let elem_id = args['elem_id']['value'];
...
exports.update_wait_data_products_step = async function(args, res, next, headers) {
  /**
   * Update a wait data products step
   *
   * elem_id String unique id of a procedure element
   * step WaitDataProductsStep Definition of wait data products step
...
exports.update_wait_data_products_step_input = async function(args, res, next, headers) {
  /**
   * Update user input of a wait data products step
   *
   * elem_id String unique id of a procedure element
   * user_input WaitDataProductsInputSpec User input values
   * no response value expected for this operation
   **/
  const key = node_funcs.get_auth_key(headers);
  let execution_id = args['execution_id']['value'];
