...
exports.create_cmd_scmf_step = async function(args, res, next, headers) {
  /**
   * Create a cmd scmf step
   *
   ...
   * returns AddCmdSCMFStepResponse
   **/
  ...
  try {
    const data = await node_funcs.createArchiveElement(execution_id, null, "STEP", "CMD_SCMF", step, insert_after_id, level, key); 
...
exports.get_cmd_scmf_step = async function(args, res, next, headers) {
  /**
   * Get a cmd scmf step
   *
...
exports.get_cmd_scmf_step_input = async function(args, res, next, headers) {
  /**
   * Get user input of a cmd scmf step
   *
   * elem_id String unique id of a procedure element
   * returns CmdSCMFInputSpec
   **/
  const key = node_funcs.get_auth_key(headers);
  let execution_id = args['execution_id']['value'];
  let elem_id = args['elem_id']['value'];
...
exports.get_cmd_scmf_step_result = async function(args, res, next, headers) {
  /**
   * Get result of a cmd scmf step
   *
   * elem_id String unique id of a procedure element
   * returns CmdSCMFResultSpec
   **/
  const key = node_funcs.get_auth_key(headers);
  let execution_id = args['execution_id']['value'];
  let elem_id = args['elem_id']['value'];
...
exports.get_execution_cmd_scmf_steps = async function(args, res, next, headers) {
  /**
   * Get cmd scmf steps of the execution. List is sorted by the order in the execution.
   *
   * execution_id String unique id of execution
...
exports.update_cmd_scmf_step = async function(args, res, next, headers) {
  /**
   * Update a cmd scmf step
   *
   * elem_id String unique id of a procedure element
   * step CmdSCMFStep Definition of cmd scmf step
...
exports.update_cmd_scmf_step_input = async function(args, res, next, headers) {
  /**
   * Update user input of a cmd scmf step
   *
   * elem_id String unique id of a procedure element
   * user_input CmdSCMFInputSpec User input values
   * no response value expected for this operation
   **/
  const key = node_funcs.get_auth_key(headers);
  let execution_id = args['execution_id']['value'];
