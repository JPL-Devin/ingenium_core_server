...
exports.create_procedure_manual_eip_step = async function(args, res, next, headers) {
  /**
  ...
  try {
    const data = await node_funcs.createArchiveElement(null, procedure_id, "STEP", "MANUAL_EIP", step, insert_after_id, level, key); 
...
exports.get_procedure_manual_eip_step = async function(args, res, next, headers) {
  /**
...
exports.get_procedure_manual_eip_step_input = async function(args, res, next, headers) {
  /**
...
exports.get_procedure_manual_eip_steps = async function(args, res, next, headers) {
  /**
...
exports.update_procedure_manual_eip_step = async function(args, res, next, headers) {
  /**
...
exports.update_procedure_manual_eip_step_input = async function(args, res, next, headers) {
  /**
