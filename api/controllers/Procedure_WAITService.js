...
exports.create_procedure_wait_step = async function(args, res, next, headers) {
  /**
   * Create a wait step
   *
  ...
  try {
    const data = await node_funcs.createArchiveElement(null, procedure_id, "STEP", "WAIT", step, insert_after_id, level, key); 
...
exports.get_procedure_wait_step = async function(args, res, next, headers) {
  /**
   * Get a wait step
   *
   * procedure_id String unique id of procedure
...
exports.get_procedure_wait_step_input = async function(args, res, next, headers) {
  /**
...
exports.get_procedure_wait_steps = async function(args, res, next, headers) {
  /**
...
exports.update_procedure_wait_step = async function(args, res, next, headers) {
  /**
   * Update a wait step
   *
   * procedure_id String unique id of procedure
...
exports.update_procedure_wait_step_input = async function(args, res, next, headers) {
  /**
