...
exports.create_procedure_toc_step = async function(args, res, next, headers) {
  /**
   * Create a toc step
   *
  ...
  try {
    const data = await node_funcs.createArchiveElement(null, procedure_id, "STEP", "TOC", step, insert_after_id, level, key); 
...
exports.get_procedure_toc_step = async function(args, res, next, headers) {
  /**
   * Get a toc step
   *
   * procedure_id String unique id of procedure
...
exports.get_procedure_toc_steps = async function(args, res, next, headers) {
  /**
...
exports.update_procedure_toc_step = async function(args, res, next, headers) {
  /**
   * Update a toc step
   *
   * procedure_id String unique id of procedure
