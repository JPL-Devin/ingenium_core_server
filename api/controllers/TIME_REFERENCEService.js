...
exports.create_time_reference_step = async function(args, res, next, headers) {
  /**
   * Create a time reference step
   *
   ...
   * returns AddTimeReferenceStepResponse
   **/
  ...
  try {
    const data = await node_funcs.createArchiveElement(execution_id, null, "STEP", "TIME_REFERENCE", step, insert_after_id, level, key); 
...
exports.get_execution_time_reference_steps = async function(args, res, next, headers) {
  /**
   * Get time reference steps of the execution. List is sorted by the order in the execution.
   *
   * execution_id String unique id of execution
...
exports.get_time_reference_step = async function(args, res, next, headers) {
  /**
   * Get a time reference step
   *
   * elem_id String unique id of a procedure element
   * returns TimeReferenceStep
   **/
  const key = node_funcs.get_auth_key(headers);
  let execution_id = args['execution_id']['value'];
...
exports.get_time_reference_step_input = async function(args, res, next, headers) {
  /**
   * Get user input of a time reference step
   *
   * elem_id String unique id of a procedure element
   * returns TimeReferenceStepInput
   **/
  const key = node_funcs.get_auth_key(headers);
  let execution_id = args['execution_id']['value'];
  let elem_id = args['elem_id']['value'];
...
exports.get_time_reference_step_result = async function(args, res, next, headers) {
  /**
   * Get result of a time reference step
   *
   * elem_id String unique id of a procedure element
   * returns TimeReferenceStepResult
   **/
  const key = node_funcs.get_auth_key(headers);
  let execution_id = args['execution_id']['value'];
  let elem_id = args['elem_id']['value'];
...
exports.update_time_reference_step = async function(args, res, next, headers) {
  /**
   * Update a time reference step
   *
   * elem_id String unique id of a procedure element
   * step TimeReferenceStep Definition of time reference step
...
exports.update_time_reference_step_input = async function(args, res, next, headers) {
  /**
   * Update user input of a time reference step
   *
   * elem_id String unique id of a procedure element
   * user_input TimeReferenceStepInput User input values
   * no response value expected for this operation
   **/
  const key = node_funcs.get_auth_key(headers);
  let execution_id = args['execution_id']['value'];
