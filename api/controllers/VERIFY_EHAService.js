...
exports.create_verify_eha_step = async function(args, res, next, headers) {
  /**
   * Create a verify eha step
   *
   ...
   * returns AddVerifyEHAStepResponse
   **/
  ...
  try {
    const data = await node_funcs.createArchiveElement(execution_id, null, "STEP", "VERIFY_EHA", step, insert_after_id, level, key); 
...
exports.get_execution_verify_eha_steps = async function(args, res, next, headers) {
  /**
   * Get verify EHA steps of the execution. List is sorted by the order in the execution.
   *
   * execution_id String unique id of execution
...
exports.get_verify_eha_step = async function(args, res, next, headers) {
  /**
   * Get a verify eha step
   *
   * elem_id String unique id of a procedure element
   * returns VerifyEHAStep
   **/
  const key = node_funcs.get_auth_key(headers);
  let execution_id = args['execution_id']['value'];
...
exports.get_verify_eha_step_input = async function(args, res, next, headers) {
  /**
   * Get user input of a verify eha step
   *
   * elem_id String unique id of a procedure element
   * returns VerifyEHAInputSpec
   **/
  const key = node_funcs.get_auth_key(headers);
  let execution_id = args['execution_id']['value'];
  let elem_id = args['elem_id']['value'];
...
exports.get_verify_eha_step_result = async function(args, res, next, headers) {
  /**
   * Get result of a verify eha step
   *
   * elem_id String unique id of a procedure element
   * returns VerifyEHAResultSpec
   **/
  const key = node_funcs.get_auth_key(headers);
  let execution_id = args['execution_id']['value'];
  let elem_id = args['elem_id']['value'];
...
exports.update_verify_eha_step = async function(args, res, next, headers) {
  /**
   * Update a verify eha step
   *
   * elem_id String unique id of a procedure element
   * step VerifyEHAStep Definition of verify eha step
...
exports.update_verify_eha_step_input = async function(args, res, next, headers) {
  /**
   * Update user input of a verify eha step
   *
   * elem_id String unique id of a procedure element
   * user_input VerifyEHAInputSpec User input values
   * no response value expected for this operation
   **/
  const key = node_funcs.get_auth_key(headers);
  let execution_id = args['execution_id']['value'];
