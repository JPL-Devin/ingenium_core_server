...
exports.create_cmd_sse_step = async function(args, res, next, headers) {
  /**
   * Create a cmd sse step
   *
  ...
  try {
    const data = await node_funcs.createArchiveElement(execution_id, null, "STEP", "CMD_SSE", step, insert_after_id, level, key); 
...
exports.get_cmd_sse_step = async function(args, res, next, headers) {
  /**
   * Get a cmd sse step
   *
...
exports.get_cmd_sse_step_input = async function(args, res, next, headers) {
  /**
   * Get user input of a cmd sse step
   *
   * elem_id String unique id of a procedure element
   * returns CmdSSEInputSpec
   **/
  const key = node_funcs.get_auth_key(headers);
  let execution_id = args['execution_id']['value'];
  let elem_id = args['elem_id']['value'];
...
exports.get_cmd_sse_step_result = async function(args, res, next, headers) {
  /**
   * Get result of a cmd sse step
   *
   * elem_id String unique id of a procedure element
   * returns CmdSSEResultSpec
   **/
  const key = node_funcs.get_auth_key(headers);
  let execution_id = args['execution_id']['value'];
  let elem_id = args['elem_id']['value'];
...
exports.get_execution_cmd_sse_steps = async function(args, res, next, headers) {
  /**
   * Get cmd sse steps of the execution. List is sorted by the order in the execution.
   *
   * execution_id String unique id of execution
...
exports.update_cmd_sse_step = async function(args, res, next, headers) {
  /**
   * Update a cmd sse step
   *
   * elem_id String unique id of a procedure element
   * step CmdSSEStep Definition of cmd sse step
...
exports.update_cmd_sse_step_input = async function(args, res, next, headers) {
  /**
   * Update user input of a cmd sse step
   *
   * elem_id String unique id of a procedure element
   * user_input CmdSSEInputSpec User input values
   * no response value expected for this operation
   **/
  const key = node_funcs.get_auth_key(headers);
  let execution_id = args['execution_id']['value'];
