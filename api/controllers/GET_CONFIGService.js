...
exports.create_get_config_step = async function(args, res, next, headers) {
  /**
   * Create a get configuration step
   *
   ...
   * returns AddGetConfigStepResponse
   **/
  ...
  try {
    const data = await node_funcs.createArchiveElement(execution_id, null, "STEP", "VENUE_CONFIG_GET", step, insert_after_id, level, key); 
...
exports.get_execution_get_config_steps = async function(args, res, next, headers) {
  /**
   * Get get_config steps of the execution. List is sorted by the order in the execution.
   *
   * execution_id String unique id of execution
  ...
  let elem_type = 'STEP';
  let step_type = 'VENUE_CONFIG_GET'
...
exports.get_get_config_step = async function(args, res, next, headers) {
  /**
   * Get a get configuration step
   *
   * elem_id String unique id of a procedure element
   * returns GetConfigStep
   **/
  const key = node_funcs.get_auth_key(headers);
  let execution_id = args['execution_id']['value'];
...
exports.get_get_config_step_input = async function(args, res, next, headers) {
  /**
   * Get user input of a get config step
   *
   * elem_id String unique id of a procedure element
   * returns GetConfigValueSpec
   **/
  const key = node_funcs.get_auth_key(headers);
  let execution_id = args['execution_id']['value'];
  let elem_id = args['elem_id']['value'];
...
exports.get_get_config_step_result = async function(args, res, next, headers) {
  /**
   * Get result of a get config step
   *
   * elem_id String unique id of a procedure element
   * returns GetConfigResultSpec
   **/
  const key = node_funcs.get_auth_key(headers);
  let execution_id = args['execution_id']['value'];
  let elem_id = args['elem_id']['value'];
...
exports.update_get_config_step = async function(args, res, next, headers) {
  /**
   * Update a get config step
   *
   * elem_id String unique id of a procedure element
   * step GetConfigStep Definition of get config step
...
exports.update_get_config_step_input = async function(args, res, next, headers) {
  /**
   * Update user input of a get config step
   *
   * elem_id String unique id of a procedure element
   * user_input GetConfigValueSpec User input values
   * no response value expected for this operation
   **/
  const key = node_funcs.get_auth_key(headers);
  let execution_id = args['execution_id']['value'];
