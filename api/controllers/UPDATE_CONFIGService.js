...
exports.create_update_config_step = async function(args, res, next, headers) {
  /**
   * Create an update configuration step
   *
   ...
   * returns AddUpdateConfigStepResponse
   **/
  ...
  try {
    const data = await node_funcs.createArchiveElement(execution_id, null, "STEP", "VENUE_CONFIG_UPDATE", step, insert_after_id, level, key); 
...
exports.get_execution_update_config_steps = async function(args, res, next, headers) {
  /**
   * Get update_config steps of the execution. List is sorted by the order in the execution.
   *
   * execution_id String unique id of execution
  ...
  let elem_type = 'STEP';
  let step_type = 'VENUE_CONFIG_UPDATE'
...
exports.get_update_config_step = async function(args, res, next, headers) {
  /**
   * Get an update configuration step
   *
   * elem_id String unique id of a procedure element
   * returns UpdateConfigStep
   **/
  const key = node_funcs.get_auth_key(headers);
  let execution_id = args['execution_id']['value'];
...
exports.get_update_config_step_input = async function(args, res, next, headers) {
  /**
   * Get user input of an update config step
   *
   * elem_id String unique id of a procedure element
   * returns UpdateConfigValueSpec
   **/
  const key = node_funcs.get_auth_key(headers);
  let execution_id = args['execution_id']['value'];
  let elem_id = args['elem_id']['value'];
...
exports.get_update_config_step_result = async function(args, res, next, headers) {
  /**
   * Get result of an update config step
   *
   * elem_id String unique id of a procedure element
   * returns UpdateConfigResultSpec
   **/
  const key = node_funcs.get_auth_key(headers);
  let execution_id = args['execution_id']['value'];
  let elem_id = args['elem_id']['value'];
...
exports.update_update_config_step = async function(args, res, next, headers) {
  /**
   * Update an update config step
   *
   * elem_id String unique id of a procedure element
   * step UpdateConfigStep Definition of update config step
...
exports.update_update_config_step_input = async function(args, res, next, headers) {
  /**
   * Update user input of an update config step
   *
   * elem_id String unique id of a procedure element
   * user_input UpdateConfigValueSpec User input values
   * no response value expected for this operation
   **/
  const key = node_funcs.get_auth_key(headers);
  let execution_id = args['execution_id']['value'];
