...
exports.create_cmd_file_step = async function(args, res, next, headers) {
  /**
  ...
  try {
    const data = await node_funcs.createArchiveElement(execution_id, null, "STEP", "CMD_FILE", step, insert_after_id, level, key); 
...
exports.get_cmd_file_step = async function(args, res, next, headers) {
  /**
   * Get a cmd file step
   *
...
exports.get_cmd_file_step_input = async function(args, res, next, headers) {
  /**
   * Get user input of a cmd file step
   *
   * elem_id String unique id of a procedure element
   * returns CmdFileInputSpec
   **/
  const key = node_funcs.get_auth_key(headers);
  let execution_id = args['execution_id']['value'];
  let elem_id = args['elem_id']['value'];
...
exports.get_cmd_file_step_result = async function(args, res, next, headers) {
  /**
   * Get result of a cmd file step
   *
   * elem_id String unique id of a procedure element
   * returns CmdFileResultSpec
   **/
  const key = node_funcs.get_auth_key(headers);
  let execution_id = args['execution_id']['value'];
  let elem_id = args['elem_id']['value'];
...
exports.get_execution_cmd_file_steps = async function(args, res, next, headers) {
  /**
...
exports.update_cmd_file_step = async function(args, res, next, headers) {
  /**
...
exports.update_cmd_file_step_input = async function(args, res, next, headers) {
  /**
   * Update user input of a cmd file step
   *
   * elem_id String unique id of a procedure element
   * user_input CmdFileInputSpec User input values
   * no response value expected for this operation
   **/
  const key = node_funcs.get_auth_key(headers);
  let execution_id = args['execution_id']['value'];
