...
exports.create_gds_step = async function(args, res, next, headers) {
  /**
   * Create a GDS step
   *
  ...
  try {
    const data = await node_funcs.createArchiveElement(execution_id, null, "STEP", "GDS_MANUAL", step, insert_after_id, level, key); 
...
exports.get_execution_gds_steps = async function(args, res, next, headers) {
  /**
   * Get GDS steps of the execution. List is sorted by the order in the execution.
   *
   * execution_id String unique id of execution
...
exports.get_gds_step = async function(args, res, next, headers) {
  /**
   * Get a GDS step
   *
...
exports.get_gds_step_input = async function(args, res, next, headers) {
  /**
   * Get user input of a GDS step
   *
   * step_id String unique id of step
   * returns GDSValueSpec
   **/
  const key = node_funcs.get_auth_key(headers);
  let execution_id = args['execution_id']['value'];
  let elem_id = args['elem_id']['value'];
...
exports.get_gds_step_result = async function(args, res, next, headers) {
  /**
   * Get result of a GDS step
   *
   * step_id String unique id of step
   * returns GDSResultSpec
   **/
  const key = node_funcs.get_auth_key(headers);
  let execution_id = args['execution_id']['value'];
  let elem_id = args['elem_id']['value'];
...
exports.update_gds_step = async function(args, res, next, headers) {
  /**
   * Update a GDS step
   *
   * step_id String unique id of step
   * step GDSStep Definition of GDS step
...
exports.update_GDS_step_input = async function(args, res, next, headers) {
  /**
   * Update user input of a GDS step
   *
   * step_id String unique id of step
   * user_input GDSValueSpec User input values
   * no response value expected for this operation
   **/
  const key = node_funcs.get_auth_key(headers);
  let execution_id = args['execution_id']['value'];
